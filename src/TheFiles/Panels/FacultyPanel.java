...
public class FacultyPanel extends JPanel{
	...
	public static FacultyPanel facultyPanel;
	static JPanel table = DataBaseRetrieval.Retrieve("*","FACULTY","*","*");
	FacultyPanel(){
		try {
			...
			buttons[3].addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					remove(table);
					table = DataBaseRetrieval.Retrieve("*","FACULTY","*","*");
			...
			buttons[4].addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					remove(table);
					table = DataBaseRetrieval.Retrieve(find[0].toUpperCase(),"FACULTY",find[1].toUpperCase(),find[2].toUpperCase());
					add(table, BorderLayout.CENTER);
					revalidate();
					repaint();
				}
