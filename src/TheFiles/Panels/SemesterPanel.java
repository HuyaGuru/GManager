...
public class SemesterPanel extends JPanel {
	...
	public static SemesterPanel semesterPanel;
	static JPanel table = DataBaseRetrieval.Retrieve("*", "SEMESTER", "*", "*");
		...
		try {
			...
			buttons[0].addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					Methods.semesterInsert();
				}
			});
			buttons[1].setText("Update");
			buttons[1].addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					Methods.update("SEMESTER");
				}
			});
			buttons[2].setText("Delete");
			buttons[2].addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					Methods.delete("SEMESTER");
				}
			});
			...
			buttons[3].addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					remove(table);
					table = DataBaseRetrieval.Retrieve("*", "SEMESTER", "*", "*");
			...
			buttons[4].addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					remove(table);
					table = DataBaseRetrieval.Retrieve(find[0].toUpperCase(),"SEMESTER",find[1].toUpperCase(),find[2].toUpperCase());
					add(table, BorderLayout.CENTER);
					revalidate();
					repaint();
				}				
